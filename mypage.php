...
<body style="background-color:rgb(223,240,242);">
    ...
    <h3 style="postion:absolute;margin-top:100px;text-align:center;">Your Posts</h3>
    <!-- forum blogs -->
    <div class="row row-cols-1 row-cols-md-1 g-4" style="margin: 15px; margin-top: 0">
        ...
        $sqlCount = "SELECT COUNT(*) AS totalEntries FROM forum WHERE custno = '$custno'";
        ...
        $sql = "SELECT srno, title, LEFT(content, 900) AS truncated_content, img1, date_time 
        FROM forum  
        WHERE custno = '$custno' 
